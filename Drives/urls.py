...
urlpatterns = [
    ...
    path('listUpdate<int:id><int:d>',views.AppliedListUpdate, name="listUpdate"),
    path('ApplyReject<int:id><int:d>', views.ApplyReject, name="ApplyReject"),

    path('postDrive', views.Post_Drive,name="postDrive"),  # posting new drive
